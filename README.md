...
boot, static images and GIFs continue while only video items remain pending,
without being failed. It associates every result with an exact B2 file version,
